...
def NoCov_Plot_6_Cluster_ROC_Volcano(
    
    result_csv_path = "E:\WJW_Code_Hub\SCPDA\Report_Results_Part2\DIANN_QC_3Mix_UsePCA_NoCovariates\Results\MethodSelection_DifferentialExpressionAnalysis.csv",
    savefolder = 'E:/WJW_Code_Hub/SCPDA/Report_Results_Part2/DIANN_QC_3Mix_UsePCA_NoCovariates/Results/',

    Software = 'DIANN',
    Report_Folder = "E:/WJW_Code_Hub/SCPDA/Report_Results_Part2/DIANN_QC_3Mix_UsePCA_NoCovariates/",
    Report_Name = 'three_mix_report.pg_matrix.tsv',

    samples_csv_path = "E:/WJW_Code_Hub/SCPDA/Report_Results_Part2/DIANN_QC_3Mix_UsePCA_NoCovariates/Samples_Template.csv",
    composition_csv_path = "E:/WJW_Code_Hub/SCPDA/Report_Results_Part2/DIANN_QC_3Mix_UsePCA_NoCovariates/Composition_Template.csv",
    ...
    UseCovariates = False  # Whether to use covariates when correcting for batch effects
    ...
    for pValue in pValue_List:
        for SR in SR_methods:
            for Compared_groups in Compared_groups_label:
                ...
                savename = None
                if top1_BatchCorrection_method in ['limma', 'Combat-P', 'Combat-NP']:
                    savename= 'Clustering_{0}_{1}_{2}_{3}-NC'.format(SR, top1_Imputation_method, top1_Normalization_method, top1_BatchCorrection_method)
                else:
                ...
                if top1_BatchCorrection_method in ['limma', 'Combat-P', 'Combat-NP']:
                    title_methods = '{0}_{1}_{2}_{3}-NC_{4}_PValue{5}'.format(SR, top1_Imputation_method, top1_Normalization_method, top1_BatchCorrection_method, top1_StatisticalTest_method, str(pValue)[2:]).replace('PValue1', 'PValue10')
                ...
                if top1_BatchCorrection_method in ['limma', 'Combat-P', 'Combat-NP']:
                    Old_ROC_Filenames = [savefolder + 'ROC_{0}_{1}_{2}_{3}-NC_{4}_PValue{5}_{6}.svg'.format(SR, top1_Imputation_method, top1_Normalization_method, top1_BatchCorrection_method, top1_StatisticalTest_method, str(pValue)[2:], Compared_groups.replace('/', '_vs_')).replace('PValue1', 'PValue10'),
                                         savefolder + 'ROC_{0}_{1}_{2}_{3}-NC_{4}_PValue{5}_{6}.csv'.format(SR, top1_Imputation_method, top1_Normalization_method, top1_BatchCorrection_method, top1_StatisticalTest_method, str(pValue)[2:], Compared_groups.replace('/', '_vs_')).replace('PValue1', 'PValue10')]
            
                    New_ROC_Filenames = [savefolder + 'ROC_{0}_{1}_{2}_{3}-NC_{4}_{5}.svg'.format(SR, top1_Imputation_method, top1_Normalization_method, top1_BatchCorrection_method, top1_StatisticalTest_method, Compared_groups.replace('/', '_vs_')),
                                         savefolder + 'ROC_{0}_{1}_{2}_{3}-NC_{4}_{5}.csv'.format(SR, top1_Imputation_method, top1_Normalization_method, top1_BatchCorrection_method, top1_StatisticalTest_method, Compared_groups.replace('/', '_vs_'))]
