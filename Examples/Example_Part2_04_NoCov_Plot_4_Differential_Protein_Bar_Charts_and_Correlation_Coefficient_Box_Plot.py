...
def NoCov_Plot_4_Differential_Protein_Bar_Charts_and_Correlation_Coefficient_Box_Plot(
...
if __name__ == '__main__': 
    ...
    NoCov_Plot_4_Differential_Protein_Bar_Charts_and_Correlation_Coefficient_Box_Plot(
