...
def UseCov_Plot_3_Bar_Charts_and_Scatter_of_Statistical_Indicators(
                ...
                for BC in BatchCorrection:
                    for Norm in Normalization:
                        ...
                        if (Normalization.index(Norm) == 4):
                            ...
                            plt.ylabel(y_label, rotation = 270, horizontalalignment='center', verticalalignment='center', fontsize=8, labelpad=15, 
...
if __name__ == '__main__': 
    UseCov_Plot_3_Bar_Charts_and_Scatter_of_Statistical_Indicators(
    result_csv_path = "E:\WJW_Code_Hub\SCPDA\Report_Results_Part2\DIANN_QC_3Mix_UsePCA_UseCovariates\Second_Run_Results\MethodSelection_DifferentialExpressionAnalysis.csv",
    savefolder = 'E:/WJW_Code_Hub/SCPDA/Report_Results_Part2/DIANN_QC_3Mix_UsePCA_UseCovariates/Results/')
