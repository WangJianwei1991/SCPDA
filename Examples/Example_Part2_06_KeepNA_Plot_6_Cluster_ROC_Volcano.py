...
def KeepNA_Plot_6_Cluster_ROC_Volcano(
    ...
    Software = 'DIANN',
    Report_Folder = "E:/WJW_Code_Hub/SCPDA/Report_Results_Part2/DIANN_QC_3Mix_KeepNA_UsePCA_UseCovariates/",
    Report_Name = 'three_mix_report.pg_matrix.tsv',

    samples_csv_path = "E:/WJW_Code_Hub/SCPDA/Report_Results_Part2/DIANN_QC_3Mix_KeepNA_UsePCA_UseCovariates/Samples_Template.csv",
    composition_csv_path = "E:/WJW_Code_Hub/SCPDA/Report_Results_Part2/DIANN_QC_3Mix_KeepNA_UsePCA_UseCovariates/Composition_Template.csv",
    ...
    # 只使用支持缺失值的方法组合
    SparsityReduction = ['NoSR', 'SR66', 'SR75', 'SR90']
    Imputation = ['KeepNA']
    Normalization = ["Unnormalized", "Median", "Sum", "QN", "TRQN"]
    BatchCorrection = ['NoBC', 'limma']
    StatisticalTest = ['t-test', 'Wilcox', 'limma-trend']
    ...
    for pValue in pValue_List:
        for SR in SR_methods:
            for Compared_groups in Compared_groups_label:
                ...
                # According to KeepNA's top ranking method
                df_p_SR_KeepNA = df_p_SR[df_p_SR['Missing Value Imputation'] == 'KeepNA']

                top1_Imputation_method = df_p_SR_KeepNA['Missing Value Imputation'].values.tolist()[0] # Best Missing Value Imputation Method
                top1_Normalization_method = df_p_SR_KeepNA['Normalization'].values.tolist()[0] # Best Normalization Method
                top1_BatchCorrection_method = df_p_SR_KeepNA['Batch Correction'].values.tolist()[0] # Best Batch Correction Method
                top1_StatisticalTest_method = df_p_SR_KeepNA['Statistical Test'].values.tolist()[0] # Best Statistical Test Method
